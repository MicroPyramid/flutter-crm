...
class Contact {
  ...
  Contact.fromJson(Map contact) {
    ...
    this.description = contact['description'] != null ? contact['description'] : "";
    this.assignedTo =  contact['assigned_to']!= null ?  List<Profile>.from(contact['assigned_to'].map((x) => Profile.fromJson(x))) : [];
    this.createdBy =  contact['created_by'] != null ? Profile.fromJson(contact['created_by']) : Profile();
    this.createdOn = contact['created_on'] != null ? contact['created_on'] : "";
    this.isActive = contact['is_active'] != null ? contact['is_active'] : false;
    this.teams =  contact['teams']!= null ? List<Team>.from(contact['teams'] .map((x) => Team.fromJson(x))) : [];
    this.company = contact['company'] != null ? Company.fromJson(contact['company']) : Company();
  }
